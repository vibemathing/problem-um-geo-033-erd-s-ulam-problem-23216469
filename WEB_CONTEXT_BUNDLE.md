...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-geo-033-erd-s-ulam-problem-23216469-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GEO-033"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-geo-033-erd-s-ulam-problem-23216469-v1",
      "problem_contract_sha256": "19d2ee42f4428b6a33c5d920cc744f93cc07735c144131f3db23f26929d737d3",
      "problem_id": "problem:um-geo-033-erd-s-ulam-problem-23216469",
      "route_id": "route:um-geo-033-erd-s-ulam-problem-23216469-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-geo-033-erd-s-ulam-problem-23216469-source-fidelity-01",
      "graph_id": "graph:um-geo-033-erd-s-ulam-problem-23216469-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-geo-033-erd-s-ulam-problem-23216469-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-geo-033-erd-s-ulam-problem-23216469-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there a dense set of points in the plane with all pairwise distances rational?"
          },
          "statement_sha256": "c780b6bac6f781448fbdc3a6716e6b6cbf8adf78eb6ace6727419670be082878"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-geo-033-erd-s-ulam-problem-23216469-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-geo-033-erd-s-ulam-problem-23216469-root",
      "route_id": "route:um-geo-033-erd-s-ulam-problem-23216469-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-geo-033-6d93a2952b27",
        "url": "https://www.unsolvedmath.com/problems/GEO-033"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
